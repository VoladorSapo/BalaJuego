...
public abstract class ABaseProyectile : MonoBehaviour, IInteractable, IProyectile
{
    [Header("Data")]
    [SerializeField] protected bool grabable = true;
    ...
    public virtual void ActivateProyectileMovement(ACharacterLife shooter, float angle, Vector3 pos)
    {
